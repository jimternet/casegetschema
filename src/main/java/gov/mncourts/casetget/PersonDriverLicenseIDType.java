...
@XmlSeeAlso({
    gov.mncourts.casetget.CaseGetCitationDocumentType.Citation.Citee.PersonAssignedIDDetails.PersonDriverLicenseID.class,
    gov.mncourts.casetget.PersonDriverLicenseID.class
})
