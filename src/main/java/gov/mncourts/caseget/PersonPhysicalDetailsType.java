 ...
 *       &lt;sequence&gt;
 *         &lt;element name="PersonHeightMeasure" type="{}PersonHeightMeasureType" minOccurs="0"/&gt;
 *         &lt;element name="PersonWeightMeasure" type="{}PersonWeightMeasureType" minOccurs="0"/&gt;
 *         &lt;element name="PersonEyeColorText" type="{}EyeColorTypeCodeTextType" minOccurs="0"/&gt;
 *         &lt;element name="PersonHairColorText" type="{}HairColorTypeCodeTextType" minOccurs="0"/&gt;
 *         &lt;element name="PersonSexText" type="{}GenderTypeCodeTextType" minOccurs="0"/&gt;
 *         &lt;element ref="{}PersonEthnicity" minOccurs="0"/&gt;
 *         &lt;element ref="{}PersonRace" minOccurs="0"/&gt;
 *         &lt;element name="PersonPhysicalFeature" type="{}PersonPhysicalFeatureType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class PersonPhysicalDetailsType {
    ...
    @XmlElementRef(name = "PersonEyeColorText", type = JAXBElement.class, required = false)
    protected JAXBElement<EyeColorTypeCodeTextType> personEyeColorText;
    @XmlElementRef(name = "PersonHairColorText", type = JAXBElement.class, required = false)
    ...
    public void setPersonHairColorText(JAXBElement<HairColorTypeCodeTextType> value) {
        this.personHairColorText = value;
    }
